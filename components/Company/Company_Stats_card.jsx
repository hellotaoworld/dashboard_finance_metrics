            ...
            <Card>
                ...
                <CardBody>
                    <div className='grid grid-cols-2 gap-2'>
                        <div className='grid grid-cols'><Company_Stats_realtime></Company_Stats_realtime></div>
                        <div className='grid grid-cols'><Company_Stats_statement input={input}></Company_Stats_statement></div>
                    </div>
                </CardBody>
            </Card>
        </div>
